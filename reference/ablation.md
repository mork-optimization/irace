...
#> 0.894082996027343
#> 0.888773677763936
#> # 2026-09-14 15:59:29 UTC: Starting ablation from 1 to 124
#> # Seed: 1234567
...
#>     tmax   temp
#> 124 2739 0.7383
#> # 2026-09-14 15:59:29 UTC: Executing source and target configurations on the given instances * nrep (50)...
#> # Generating configurations (row number is ID): tmax temp 
#>   tmax    temp
#> 3 2739 35.9569
#> 4  972  0.7383
#> # 2026-09-14 15:59:31 UTC: Ablation (full) of 2 configurations on 50 instances (this may take a while ...).
#> # Best changed parameters:
#> # temp : 35.9569 -> 0.7383 
#> # 2026-09-14 15:59:33 UTC: Final best configuration:
#>   tmax   temp
#> 2 2739 0.7383
plotAblation(ablog)
...
#> 0.894082996027343
#> 0.888773677763936
#> # 2026-09-14 15:59:33 UTC: Starting ablation from 1 to 10
#> # Seed: 1234567
#> # Source configuration (row number is ID):
#>   tmax    temp
#> 1  972 35.9569
...
#>    tmax    temp
#> 10  660 67.2069
#> # 2026-09-14 15:59:33 UTC: Executing source and target configurations on the given instances * nrep (50)...
#> # 2026-09-14 15:59:36 UTC: Final best configuration:
#>   tmax    temp
#> 1  972 35.9569
