...
#> 0.941981446903129
#> 0.873476031894195
#> # 2026-09-04 11:55:54 UTC: Starting ablation from 1 to 125
#> # Seed: 1234567
...
#>     tmax    temp
#> 125 1352 42.4881
#> # 2026-09-04 11:55:54 UTC: Executing source and target configurations on the given instances * nrep (50)...
#> # Generating configurations (row number is ID): tmax temp 
#>   tmax    temp
#> 3 1352 23.4499
#> 4 4927 42.4881
#> # 2026-09-04 11:55:57 UTC: Ablation (full) of 2 configurations on 50 instances (this may take a while ...).
#> # Best changed parameters:
#> # tmax : 4927 -> 1352 
#> # 2026-09-04 11:55:59 UTC: Final best configuration:
#>   tmax    temp
#> 2 1352 42.4881
plotAblation(ablog)
...
#> 0.941981446903129
#> 0.873476031894195
#> # 2026-09-04 11:55:59 UTC: Starting ablation from 1 to 10
#> # Seed: 1234567
#> # Source configuration (row number is ID):
#>   tmax    temp
#> 1 4927 23.4499
...
#>    tmax    temp
#> 10 4614 79.6999
#> # 2026-09-04 11:55:59 UTC: Executing source and target configurations on the given instances * nrep (50)...
#> # 2026-09-04 11:56:02 UTC: Final best configuration:
#>   tmax    temp
#> 1 4927 23.4499
